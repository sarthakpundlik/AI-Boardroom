...
class BoardroomState(TypedDict):
    ...
    # Structured per-agent findings, accumulated across all rounds
    # (each entry: {agent, round, summary, detailed_findings, risks_identified,
    #  recommendations, confidence_score})
    agent_findings: Annotated[Sequence[dict], operator.add]
