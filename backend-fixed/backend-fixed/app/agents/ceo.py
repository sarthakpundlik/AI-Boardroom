...
class CEOAgent:
    ...
    async def synthesize(
        ...
        4. Render a single overall verdict as decision_outcome: "go" if the board is
           confident in proceeding, "go_with_modifications" if it should proceed with
           specific changes, "needs_further_research" if there isn't enough information
           to decide, or "not_recommended" if the board advises against it.
