...
class ReportRepository:
    ...
    async def list_by_user(self, user_id: str, page: int = 1, per_page: int = 20) -> tuple[list[Report], int]:
        """List all reports owned by a user, across every project, newest first."""
