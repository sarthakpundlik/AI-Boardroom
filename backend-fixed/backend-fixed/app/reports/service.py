...
class ReportService:
    ...
    async def list_user_reports(self, user_id: str, page: int = 1, per_page: int = 20) -> tuple[list[Report], int]:
        """List all reports owned by a user, across every project."""
        return await self.repo.list_by_user(user_id, page, per_page)
