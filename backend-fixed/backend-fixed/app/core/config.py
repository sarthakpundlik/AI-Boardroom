...
class Settings(BaseSettings):
    ...
    # --- OAuth 2.0 ---
    # NOTE: these MUST be frontend routes, not backend ones. The provider
    # redirects the browser here after consent; the frontend page then reads
    # `?code=` and POSTs it to the backend's /auth/{provider}/callback JSON
    # endpoint. This value must exactly match what src/lib/oauth.js builds
    # AND what's registered in the provider's OAuth app settings.
